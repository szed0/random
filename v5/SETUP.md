...
Six tabs: **Landscape** (the terms), **Relationships** (typed links — what a
sentence actually said connected two technologies), **Network** (the PPMI graph),
**Trends** (what is rising, with a state per technology), **Domains** (what each
classification does that the corpus does not), **Explore** (the documents behind
a term).

Map a **Technology domain** column in the sidebar — CPC, IPC, or any
